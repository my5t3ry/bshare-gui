...
> Clone/Download the repo then edit `projects.component.ts` inside [`/src/app/projects.component.ts`](/src/app/app.component.ts)
...
angular2-webpack-starter/
 ...
 │   │   ├──projects.component.spec.ts  * a simple test of components in projects.component.ts
 │   │   ├──projects.e2e.ts             * a simple end-to-end test for /
 │   │   └──projects.component.ts       * a simple version of our App component components
 │   │
